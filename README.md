...
### 스타는 스터디 타이머의 줄임말 
그룹스터디를 할 때 다른사람들이 공부하는 것을 실시간으로 보며 동기부여를 받을수 있는 서비스입니다.
...
## 타이머(스톱워치) 기능 데모
https://github.com/user-attachments/assets/19433abe-136b-4c0f-b4f4-598bc233448d
### 기능 설명
타이머 3가지 이벤트:
Start, Stop, End(스톱워치의 공부 세션은 End로 마침.)  
예) 오전 10시 ~ 11시, 1시간 공부 후 Stop -> 나중에 접속해서 공부시간 1시간부터 시작.  
예) 오전 10시 ~ 11시, 1시간 공부 후 End -> 나중에 접속해서 공부시간 0부터 시작.  
총 공부시간은 언제나 누적됨.  

0:00:08 타이머 Start & 실시간 접속 유저 트래킹(Redis 활용)  
Start 시점부터 시간 증가 - (일괄적 시간초 증가 X):온라인 체감 증가.  

0:00:26 유저들 타이머 종료 반영.  
오늘의 랭킹 반영 X, 버튼을 통해 갱신.  

0:00:45 그룹 페이지에서 최신 랭킹 반영 됨.  

0:00:52 재접속 & 유저 나감, 시연종료
